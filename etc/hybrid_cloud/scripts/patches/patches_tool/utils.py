...
import sshutils
from constants import ScriptFilePath, PatchFilePath
...
def remote_execute_cmd(host_ip, user, passwd, cmd):
...
def add_auto_route_for_fs(ip_list, user, passwd):
